      ...
      000339 85 3C 82         [24]  307 	mov	dpl, _lcd_ready
                                    308 ;	lcdlib.c:17: }
      00033C 22               [24]  309 	ret
                                    310 ;------------------------------------------------------------
                                    ...
                                    316 ;	-----------------------------------------
      00033D                        317 _LCD_Init:
                                    318 ;	lcdlib.c:19: LCD_functionSet();
      00033D 12 03 72         [24]  319 	lcall	_LCD_functionSet
                                    320 ;	lcdlib.c:20: LCD_entryModeSet(1, 1); /* increment and no shift */
      000340 75 82 07         [24]  321 	mov	dpl, #0x07
      000343 12 03 50         [24]  322 	lcall	_LCD_IRWrite
                                    323 ;	lcdlib.c:21: LCD_displayOnOffControl(1, 1, 1); /* display on, cursor on and blinking on */
      000346 75 82 0F         [24]  324 	mov	dpl, #0x0f
      000349 12 03 50         [24]  325 	lcall	_LCD_IRWrite
                                    326 ;	lcdlib.c:22: lcd_ready = 1;
      00034C 75 3C 01         [24]  327 	mov	_lcd_ready,#0x01
                                    328 ;	lcdlib.c:23: }
      00034F 22               [24]  329 	ret
                                    330 ;------------------------------------------------------------
                                    ...
                                    338 ;	-----------------------------------------
      000350                        339 _LCD_IRWrite:
      000350 AF 82            [24]  340 	mov	r7, dpl
                                    341 ;	lcdlib.c:25: lcd_ready = 0;
      000352 75 3C 00         [24]  342 	mov	_lcd_ready,#0x00
                                    343 ;	lcdlib.c:26: DB = (c & 0xf0); // high nibble, keep RS low
      000355 74 F0            [12]  344 	mov	a,#0xf0
      000357 5F               [12]  345 	anl	a,r7
      000358 F5 90            [12]  346 	mov	_P1,a
                                    347 ;	lcdlib.c:27: E = 1;  // pulse E
                                    348 ;	assignBit
      00035A D2 92            [12]  349 	setb	_P1_2
                                    350 ;	lcdlib.c:28: E = 0;
                                    351 ;	assignBit
      00035C C2 92            [12]  352 	clr	_P1_2
                                    353 ;	lcdlib.c:29: DB = (c << 4); // low nibble, keep RS low
      00035E EF               [12]  354 	mov	a,r7
      00035F C4               [12]  355 	swap	a
      000360 54 F0            [12]  356 	anl	a,#0xf0
      000362 F5 90            [12]  357 	mov	_P1,a
                                    358 ;	lcdlib.c:30: E = 1;
                                    359 ;	assignBit
      000364 D2 92            [12]  360 	setb	_P1_2
                                    361 ;	lcdlib.c:31: E = 0;
                                    362 ;	assignBit
      000366 C2 92            [12]  363 	clr	_P1_2
                                    364 ;	lcdlib.c:32: delay(DELAY_AMOUNT);
      000368 75 82 28         [24]  365 	mov	dpl, #0x28
      00036B 12 03 FB         [24]  366 	lcall	_delay
                                    367 ;	lcdlib.c:33: lcd_ready = 1;
      00036E 75 3C 01         [24]  368 	mov	_lcd_ready,#0x01
                                    369 ;	lcdlib.c:34: }
      000371 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    ...
                                    377 ;	-----------------------------------------
      000372                        378 _LCD_functionSet:
                                    379 ;	lcdlib.c:36: lcd_ready = 0;
      000372 75 3C 00         [24]  380 	mov	_lcd_ready,#0x00
                                    381 ;	lcdlib.c:39: DB = 0x20;  // DB<7:4> = 0010, <RS,E,x,x>=0
      000375 75 90 20         [24]  382 	mov	_P1,#0x20
                                    383 ;	lcdlib.c:40: E = 1;
                                    384 ;	assignBit
      000378 D2 92            [12]  385 	setb	_P1_2
                                    386 ;	lcdlib.c:41: E = 0;
                                    387 ;	assignBit
      00037A C2 92            [12]  388 	clr	_P1_2
                                    389 ;	lcdlib.c:42: delay(DELAY_AMOUNT);
      00037C 75 82 28         [24]  390 	mov	dpl, #0x28
      00037F 12 03 FB         [24]  391 	lcall	_delay
                                    392 ;	lcdlib.c:43: E = 1;
                                    393 ;	assignBit
      000382 D2 92            [12]  394 	setb	_P1_2
                                    395 ;	lcdlib.c:44: E = 0;
                                    396 ;	assignBit
      000384 C2 92            [12]  397 	clr	_P1_2
                                    398 ;	lcdlib.c:45: delay(DELAY_AMOUNT); // added, to ensure sufficient delay
      000386 75 82 28         [24]  399 	mov	dpl, #0x28
      000389 12 03 FB         [24]  400 	lcall	_delay
                                    401 ;	lcdlib.c:46: DB7 = 1; // 2-line model
                                    402 ;	assignBit
      00038C D2 97            [12]  403 	setb	_P1_7
                                    404 ;	lcdlib.c:48: E = 1;
                                    405 ;	assignBit
      00038E D2 92            [12]  406 	setb	_P1_2
                                    407 ;	lcdlib.c:49: E = 0;
                                    408 ;	assignBit
      000390 C2 92            [12]  409 	clr	_P1_2
                                    410 ;	lcdlib.c:50: delay(DELAY_AMOUNT);
      000392 75 82 28         [24]  411 	mov	dpl, #0x28
      000395 12 03 FB         [24]  412 	lcall	_delay
                                    413 ;	lcdlib.c:51: lcd_ready = 1;
      000398 75 3C 01         [24]  414 	mov	_lcd_ready,#0x01
                                    415 ;	lcdlib.c:52: }
      00039B 22               [24]  416 	ret
                                    417 ;------------------------------------------------------------
                                    ...
                                    425 ;	-----------------------------------------
      00039C                        426 _LCD_write_char:
      00039C AF 82            [24]  427 	mov	r7, dpl
                                    428 ;	lcdlib.c:55: lcd_ready = 0;
      00039E 75 3C 00         [24]  429 	mov	_lcd_ready,#0x00
                                    430 ;	lcdlib.c:56: DB = (c & 0xf0) | 0x08; //; keep the RS
      0003A1 74 F0            [12]  431 	mov	a,#0xf0
      0003A3 5F               [12]  432 	anl	a,r7
      0003A4 44 08            [12]  433 	orl	a,#0x08
      0003A6 F5 90            [12]  434 	mov	_P1,a
                                    435 ;	lcdlib.c:57: RS = 1;
                                    436 ;	assignBit
      0003A8 D2 93            [12]  437 	setb	_P1_3
                                    438 ;	lcdlib.c:58: E = 1;
                                    439 ;	assignBit
      0003AA D2 92            [12]  440 	setb	_P1_2
                                    441 ;	lcdlib.c:59: E = 0;
                                    442 ;	assignBit
      0003AC C2 92            [12]  443 	clr	_P1_2
                                    444 ;	lcdlib.c:60: DB = (c << 4) | 0x08; // keep the RS
      0003AE EF               [12]  445 	mov	a,r7
      0003AF C4               [12]  446 	swap	a
      0003B0 54 F0            [12]  447 	anl	a,#0xf0
      0003B2 FF               [12]  448 	mov	r7,a
      0003B3 74 08            [12]  449 	mov	a,#0x08
      0003B5 4F               [12]  450 	orl	a,r7
      0003B6 F5 90            [12]  451 	mov	_P1,a
                                    452 ;	lcdlib.c:61: E = 1;
                                    453 ;	assignBit
      0003B8 D2 92            [12]  454 	setb	_P1_2
                                    455 ;	lcdlib.c:62: E = 0;
                                    456 ;	assignBit
      0003BA C2 92            [12]  457 	clr	_P1_2
                                    458 ;	lcdlib.c:63: delay(DELAY_AMOUNT);
      0003BC 75 82 28         [24]  459 	mov	dpl, #0x28
      0003BF 12 03 FB         [24]  460 	lcall	_delay
                                    461 ;	lcdlib.c:64: lcd_ready = 1;
      0003C2 75 3C 01         [24]  462 	mov	_lcd_ready,#0x01
                                    463 ;	lcdlib.c:65: }
      0003C5 22               [24]  464 	ret
                                    465 ;------------------------------------------------------------
                                    ...
                                    473 ;	-----------------------------------------
      0003C6                        474 _LCD_write_string:
      0003C6 AD 82            [24]  475 	mov	r5, dpl
      0003C8 AE 83            [24]  476 	mov	r6, dph
      0003CA AF F0            [24]  477 	mov	r7, b
                                    478 ;	lcdlib.c:67: while (*str++) {
      0003CC                        479 00101$:
      0003CC 8D 82            [24]  480 	mov	dpl,r5
      0003CE 8E 83            [24]  481 	mov	dph,r6
      0003D0 8F F0            [24]  482 	mov	b,r7
      0003D2 12 05 2B         [24]  483 	lcall	__gptrget
      0003D5 FC               [12]  484 	mov	r4,a
      0003D6 A3               [24]  485 	inc	dptr
      0003D7 AD 82            [24]  486 	mov	r5,dpl
      0003D9 AE 83            [24]  487 	mov	r6,dph
      0003DB EC               [12]  488 	mov	a,r4
      0003DC 60 1C            [24]  489 	jz	00104$
                                    490 ;	lcdlib.c:68: LCD_write_char(*str);
      0003DE 8D 82            [24]  491 	mov	dpl,r5
      0003E0 8E 83            [24]  492 	mov	dph,r6
      0003E2 8F F0            [24]  493 	mov	b,r7
      0003E4 12 05 2B         [24]  494 	lcall	__gptrget
      0003E7 F5 82            [12]  495 	mov	dpl,a
      0003E9 C0 07            [24]  496 	push	ar7
      0003EB C0 06            [24]  497 	push	ar6
      0003ED C0 05            [24]  498 	push	ar5
      0003EF 12 03 9C         [24]  499 	lcall	_LCD_write_char
      0003F2 D0 05            [24]  500 	pop	ar5
      0003F4 D0 06            [24]  501 	pop	ar6
      0003F6 D0 07            [24]  502 	pop	ar7
      0003F8 80 D2            [24]  503 	sjmp	00101$
      0003FA                        504 00104$:
                                    505 ;	lcdlib.c:70: }
      0003FA 22               [24]  506 	ret
                                    507 ;------------------------------------------------------------
      ...
      0003FB                        518 dhere:
      0003FB D5 82 FD         [24]  519 	djnz	dpl, dhere
                                    520 ;	lcdlib.c:77: }
      0003FE 22               [24]  521 	ret
                                    522 	.area CSEG    (CODE)
                                    523 	.area CONST   (CODE)
                                    524 	.area XINIT   (CODE)
